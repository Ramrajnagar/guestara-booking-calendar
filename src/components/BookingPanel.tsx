...
export const BookingPanel: React.FC<BookingPanelProps> = ({ selectedRange, bookings }) => {
            ...
            <div key={booking.id} className="booking-card">
              ...
              <div className="booking-details">
                ...
                <div className="detail-item">
                  ...
                  <span className="detail-value">{booking.currency} {booking.totalAmount.toLocaleString()}</span>
                </div>
                <div className="detail-item">
